var gramLogic2 = (function() {
    ...
    return {
      ...
      var GramLogicLexer = require('assets/js/antlr4/parser_entrada/GramLogicLexer').GramLogicLexer; 
      var GramLogicParser = require('assets/js/antlr4/parser_entrada/GramLogicParser').GramLogicParser; 
      var HtmlErrorListener = require('assets/js/antlr4/parser_entrada/HtmlErrorListener').HtmlErrorListener;
      var HtmlGramLogicListener = require('assets/js/antlr4/parser_entrada/HtmlGramLogicListener').HtmlGramLogicListener;
