var gramLogic = (function() {
    ...
    return {
      ...
      var GramLogicLexer = require('assets/js/antlr4/parser_formula/GramLogicLexer').GramLogicLexer; 
      var GramLogicParser = require('assets/js/antlr4/parser_formula/GramLogicParser').GramLogicParser; 
      var HtmlErrorListener = require('assets/js/antlr4/parser_formula/HtmlErrorListener').HtmlErrorListener;
      var HtmlGramLogicListener = require('assets/js/antlr4/parser_formula/HtmlGramLogicListener').HtmlGramLogicListener;
